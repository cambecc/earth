...
var globes = function() {
    ...
    function clampedBounds(bounds, view) {
        ...
        var xMax = Math.min(Math.ceil(ensureNumber(lowerRight[0], 900)), 900 - 1);
        var yMax = Math.min(Math.ceil(ensureNumber(lowerRight[1], 705)), 705 - 1);
    ...
    function standardGlobe() {
        return {
            ...
            fit: function(view) {
                ...
                return Math.min(900 / hScale, 705 / vScale) * 0.9;
            },
